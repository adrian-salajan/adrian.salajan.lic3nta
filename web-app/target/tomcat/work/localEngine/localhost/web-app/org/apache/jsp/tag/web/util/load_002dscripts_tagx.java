...
static {
  ...
  public void doTag() throws JspException, java.io.IOException {
    ...
    try {
      ...
      out.write("<link href=\"" + (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${customcss}", java.lang.String.class, (PageContext)this.getJspContext(), null, false) + "\" type=\"text/css\" rel=\"stylesheet\"/>");
      ...
      out.write("</script>");
      out.write("<script type=\"text/javascript\" src=\"" + (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${jq}", java.lang.String.class, (PageContext)this.getJspContext(), null, false) + "\">");
      out.write("</script>");
      out.write("<script type=\"text/javascript\" src=\"" + (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${tablesorter}", java.lang.String.class, (PageContext)this.getJspContext(), null, false) + "\">");
      out.write("</script>");
      ...
      out.write("\t\t\tcategory = document.getElementById('selectedForm');\n");
      out.write("\t\t\tcatId = category.options[category.selectedIndex].value;\n");
      out.write("\t\t\tlocation.href = \"index?categoryId=\" + catId;\n");
      out.write("\t\t}\n");
      out.write("\t   \n");
      out.write("\t   function submitBascket() {\n");
      out.write("\t\t   form = document.getElementById(\"bascketForm\");\n");
      out.write("\t\t   form.action=\"/web-app/bascket/step2\";\n");
      ...
      out.write("<script type=\"text/javascript\">");
      out.write("\n");
      out.write("var originalOptions = '--';\n");
      out.write("var originalRole;\n");
      out.write("function updateRegionsBySale() {\n");
      out.write("\trole = $(\"input:radio[name=selectedRole]:checked\").val();\n");
      out.write("\tif (typeof role === \"undefined\")  \n");
      out.write("\t\t{}\n");
      out.write("\telse {\n");
      out.write("\t\t\tif (role == 'CLIENT') {\n");
      out.write("\t\t\t\t$('#user-regions').addClass('invisible');\n");
      out.write("\t\t\t\t$('#user-regions').removeClass('visible');\n");
      out.write("\t\t\t} else {\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tif (role == originalRole) {\n");
      out.write("\t\t\t\t\t$('#user-regions ul').empty();\n");
      out.write("\t\t\t\t\t$('#user-regions ul').append(originalOptions);\n");
      out.write("\t\t\t\t} else {\n");
      out.write("\t\t\t\t\tif (role == 'SALES') {\n");
      out.write("\t\t\t\t\t\t$.getJSON('/web-app/admin/regionsForSale', function(response) {\n");
      out.write("\t\t\t\t\t\t\t availableList = $('#user-regions ul');\n");
      out.write("\t\t\t\t\t\t\t availableList.empty();\n");
      out.write("\t\t\t\t\t\t\t\t\tindex = 0;\n");
      out.write("\t\t\t\t\t\t\t\t \t$.each(response.availableRegions, function(key, val) {\n");
      out.write("\t\t\t\t\t\t\t\t \t\tinput = '");
      out.write("<input value=\"' + val.name + '\" type=\"checkbox\" class=\"region\" id=\"selectedRegions'+index+'\" name=\"selectedRegions\"/>");
      out.write("';\n");
      out.write("\t\t\t\t\t\t\t\t \t\tinput = input + '");
      out.write("<label for=\"selectedRegions' +index +'\">");
      out.write("' + val.name + '");
      out.write("</label>");
      out.write("';\n");
      out.write("\t\t\t\t\t\t\t\t\t\tavailableList.append('");
      out.write("<li>");
      out.write("' + input + '");
      out.write("</li>");
      out.write("');\n");
      out.write("\t\t\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\t\t index = 0;\n");
      out.write("\t\t\t\t\t\t\t\t $.each(response.unAvailableRegions, function(key, val) {\n");
      out.write("\t\t\t\t\t\t\t\t \t\tinput = '");
      out.write("<input value=\"' + val.name + '\" type=\"checkbox\" class=\"region\" disabled=\"disabled\" id=\"dummyRegions'+index+'\" name=\"dummyRegions\"/>");
      out.write("'\n");
      out.write("\t\t\t\t\t\t\t\t \t\tinput = input + '");
      out.write("<label for=\"dummyRegions' +index +'\">");
      out.write("' + val.name + '");
      out.write("</label>");
      out.write("';\n");
      out.write("\t\t\t\t\t\t\t\t\t\tavailableList.append('");
      ...
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\t$('#user-regions').removeClass('invisible');\n");
      out.write("\t\t\t\t$('#user-regions').addClass('visible');\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t}\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\n");
      out.write("\n");
      out.write("function hideRegionsByRole() {\n");
      out.write("\trole = $(\"input:radio[name=selectedRole]:checked\").val();\n");
      out.write("\t\tif (typeof role === \"undefined\")  \n");
      out.write("\t\t\t{}\n");
      out.write("\t\telse {\n");
      ...
      out.write(" \t\toriginalOptions =  $('#user-regions ul').children();\n");
      out.write(" \t\toriginalRole = $(\"input:radio[name=selectedRole]:checked\").val();\n");
      out.write(" \t\t$(\"#sorted-table\").tablesorter();\n");
      out.write(" \t\thideRegionsByRole();\n");
      out.write(" \t\t\n");
      out.write(" \t\t\n");
      out.write(" \t\tvar address = $('#address');\n");
      out.write(" \t\tif (address) {\n");
      out.write(" \t\t\tif ($('#negotiation').attr('checked')) {\n");
      out.write(" \t\t\t\taddress.addClass('invisible');\n");
      out.write(" \t\t\t\taddress.removeClass('visible')\n");
      out.write(" \t\t\t} else {\n");
      out.write(" \t\t\t\taddress.addClass('visible');\n");
      out.write(" \t\t\t\taddress.remove('invisible');\n");
      out.write(" \t\t\t}\n");
      out.write(" \t\t}\n");
      out.write("\t});\n");
      out.write("</script>");
  ...
  private boolean _jspx_meth_spring_005furl_005f6(PageContext _jspx_page_context)
    ...
    _jspx_th_spring_005furl_005f6.setParent(new javax.servlet.jsp.tagext.TagAdapter((javax.servlet.jsp.tagext.SimpleTag) this ));    // /WEB-INF/tags/util/load-scripts.tagx(12,62) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f6.setVar("jq");
    // /WEB-INF/tags/util/load-scripts.tagx(12,62) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f7(PageContext _jspx_page_context)
    ...
    _jspx_th_spring_005furl_005f7.setParent(new javax.servlet.jsp.tagext.TagAdapter((javax.servlet.jsp.tagext.SimpleTag) this ));    // /WEB-INF/tags/util/load-scripts.tagx(13,80) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f7.setVar("tablesorter");
    // /WEB-INF/tags/util/load-scripts.tagx(13,80) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f7.setValue("/resources/js/jquery.tablesorter.js");
  ...
  private boolean _jspx_meth_spring_005furl_005f8(PageContext _jspx_page_context)
    ...
    _jspx_th_spring_005furl_005f8.setParent(new javax.servlet.jsp.tagext.TagAdapter((javax.servlet.jsp.tagext.SimpleTag) this ));    // /WEB-INF/tags/util/load-scripts.tagx(14,70) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f8.setVar("customcss");
    // /WEB-INF/tags/util/load-scripts.tagx(14,70) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f8.setValue("/resources/styles/custom.css");
  ...
  private boolean _jspx_meth_c_005fset_005f0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_005fset_005f0.setParent(new javax.servlet.jsp.tagext.TagAdapter((javax.servlet.jsp.tagext.SimpleTag) this ));    // /WEB-INF/tags/util/load-scripts.tagx(23,27) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fset_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/tags/util/load-scripts.tagx(24,26) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fset_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/tags/util/load-scripts.tagx(25,68) name = default type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fout_005f0.setDefault("en");
    // /WEB-INF/tags/util/load-scripts.tagx(25,68) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
